            ...
            <div className="background--white">
              <section className="section section--extra-top-padding">
                <div className="heading">
                  ...
                  <span className="heading__text"><p>Hinner du inte gå en lång kurs? Ta en titt på våra webinarer!</p></span>
                </div>
              </section>
            </div>
                        ...
                        <div className="section__column section__column--6 wysiwyg-content">
                            <section className="section section--grid section--wrap section--no-vertical-padding">
                                <div className="section__column">
                                    ...
                                    <p>Kursen riktar sig till dig som idag har en roll där du förväntas engagera, driva och styra en grupp, men där din arbetsbeskrivning ej innehåller ett formellt chefsmandat. Du arbetar troligtvis som team-, arbets- eller projektledare, samordnare, koordinator eller på annat sätt ansvar för en grupp/team av personer.</p>
                                    <h3>Vem bör deltaga?</h3>
                                    <p>Easy2perform samarbetar enbart med pedagogiskt skickliga kursledare, alla med lång erfarenhet av att anpassa utbildning och kompetensutveckling till deltagarnas behov. Vi vet att en ökad individuell anpassning ger deltagaren ännu mer behållning av kursen.</p>
                                    <p>
                                        <Checkout />
                                    </p>
                                </div>
